...
def build_agentic_rag_graph(
    ...
    graph.add_node("prepare_retrieval", nodes.prepare_retrieval)
    ...
    graph.add_conditional_edges("answer_repair", route_after_answer)
    graph.add_edge("targeted_retrieval", "prepare_retrieval")
